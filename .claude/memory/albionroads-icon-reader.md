...
metadata: 
  ...
  modified: 2026-08-02T12:15:05.037Z
---
...
- **Small vs large resources is the cleared ground, not the sprite.** Both sizes draw an
  ...
  against each map's own terrain coverage or it just detects brown maps.
...
chest colours (already known) and over-reports dungeons (found on 2026-08-02 — `Casos-Aximam` is
tabulated at 2 dungeons and its map draws 1). Treat disagreements as needing a human, not as
reader bugs. See [[albionroads-docs]] for where the proposal records the measured agreement.
