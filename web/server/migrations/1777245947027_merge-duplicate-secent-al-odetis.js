/**
 * The feed carried Secent-Al-Odetis twice, once misspelling the "Al" joiner with
 * a capital I, so the catalogue had two ids for one zone and rooms split their
 * history across both. The typo id is gone; its rows move to the real one.
 *
 ...
 */
export const up = (pgm) => {
  const OLD = 'secent-ai-odetis';
  const NEW = 'secent-al-odetis';
